...
This project is designed to test the **Osaka Masjid Loader** component within a Next.js application. It features a premium, spiritual-themed loading experience with smooth animations.
...
- **Icons**: Font Awesome (pulse-effect icons)
...
- `app/page.tsx`: The main page demonstrating the loader usage.
